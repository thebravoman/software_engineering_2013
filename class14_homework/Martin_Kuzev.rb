...
class ChartDrawer
        ...
        def loop_months data
                ...
                colors = ["orange","green","red","yellow","purple","blue","black","pink","brown","grey","violet"]
                months.times do |n|
        ...
        def draw_values_lines data
                loop_months(data) do |n,months,color|
                        @drawer.line n-30,data[1][n+1].to_i,80,data[1][n+1].to_i 
                        @drawer.text "#{data[1][n+1].to_i}",n-70,data[1][n+1].to_i 
                        
                        @drawer.line -30,data[1][n+1].to_i-data[1][n+1].to_i,175,data[1][0].to_i 
                        @drawer.text "#{data[0][1].to_i}",-70,data[0][0].to_i 
...
d = Drawer.new "Martin_Kuzev.svg", 300,350
d.start
