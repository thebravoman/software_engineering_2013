...
class Drawer
	  ...
	  def start
                ...
                @el_svg=@document.add_element "svg"
                @el_svg.attributes["version"]="1.1"
                @el_svg.attributes["xmlns"]="http://www.w3.org/2000/svg"
         end


	 def initialize f_name="result.svg",x,y
                self.f_name=f_name
                self.x=x
                self.y=y
     	 end
	...
	def c_sys
        ...
        def finish
                File.open(self.f_name,"w") do |svg|
...
a=Drawer.new "mat.svg",330,330
a.start
a.c_sys

b=MathDrawer.new a

b.graphic ARGV[0].to_i,ARGV[1].to_i,ARGV[2].to_i
a.finish
