...
if (D<0)
	...
	drawer.text "V( #{X};#{Y} )", -600, 120
	
	drawer.point1 X*10, Y*10
	
	if(A>0)
	drawer.point1 X*10+7, Y*10+3
	drawer.point1 X*10-7, Y*10+3
	drawer.point1 X*10+17, Y*10+13
	drawer.point1 X*10-17, Y*10+13
	drawer.point1 X*10+32, Y*10+40
	drawer.point1 X*10-32, Y*10+40
	drawer.point1 X*10+40, Y*10+70
	drawer.point1 X*10-40, Y*10+70
	drawer.point1 X*10+50, Y*10+100
	drawer.point1 X*10-50, Y*10+100
	drawer.point1 X*10+55, Y*10+140
	drawer.point1 X*10-55, Y*10+140
	drawer.point1 X*10+60, Y*10+200
	drawer.point1 X*10-60, Y*10+200
	end
