...
Task 3: Designing the content layout, by Georgi 
...
Task 2: Creating the add option to manipulate the content in the site, by Alexander
Task 3: Creating the move option to manipulate the content in the site, by Alexander
Task 4: Creating the delete option to manipulate the content in the site, by Alexander
...
Task 1: The layout of the contact from, by Alexander
Task 2: Creating the submit email field, by Georgi
Task 3: Creating the submit fax field, by Georgi
Task 4: Creating the submit phone number field, by Georgi
Task 5: Creating the submit address field, by Georgi
...
Task 2: Implementing the gallery in the site, by Georgi
...
Task 5: testing the gallery slide function, by Alexander
