Title:Single player
	...
	Task1:Algorithym that must use computer  for fighting with the human controled hero-Asen
...
Title:Improved vision
	...
	Task4:Headlt bar that shows current health of the hero and the decressing health graphicly by decreasing the size of the bar-Vladimir
